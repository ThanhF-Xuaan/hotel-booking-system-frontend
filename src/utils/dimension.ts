 ...
 */
export const normalizeDimensionString = (input: string): string | null => {
  if (!input) return '';
  ...
  const normalizePart = (part: string): string | null => {
 ...
 */
export const parseDimensionString = (sizeStr: string): { width: number; height: number } | null => {
