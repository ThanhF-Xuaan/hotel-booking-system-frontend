...
export interface CampaignModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (payload: CampaignCreateRequest | CampaignUpdateRequest) => Promise<void>;
  editingItem: CampaignResponse | null;
}
...
const CampaignModal: React.FC<CampaignModalProps> = ({ isOpen, onClose, onSave, editingItem }) => {
