...
export interface DiscountRuleTypeModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const DiscountRuleTypeModal: React.FC<DiscountRuleTypeModalProps> = ({ isOpen, onClose, onSave, editingItem }) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      ...
      setSubmitError(axiosError.response?.data?.message || 'Failed to save discount rule type configuration.');
    } finally {
      setIsLoading(false);
    }
  };
